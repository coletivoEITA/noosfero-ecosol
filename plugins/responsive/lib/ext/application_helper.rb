...
module ApplicationHelper
  ...
  module ResponsiveMethods
    ...
    def search_contents_menu
      ...
      output += link_to(_('Contents'), '#', :class=>"dropdown-toggle icon-menu-articles", title: content_tag(:span, _('Contents')), :'data-toggle'=>"dropdown", :'data-hover'=>"dropdown")
    ...
    def search_people_menu
      ...
      output = '<li class="dropdown">'
      output += link_to(_('People'), '#', :class=>"dropdown-toggle icon-menu-people", title: content_tag(:span, _('People')), :'data-toggle'=>"dropdown", :'data-hover'=>"dropdown")
      output += '<ul class="dropdown-menu" role="menu">'
    ...
    def search_communities_menu
      ...
      output = '<li class="dropdown">'
      output += link_to(_('Communities'), '#', :class=>"dropdown-toggle icon-menu-community", title: content_tag(:span, _('Communities')), :'data-toggle'=>"dropdown", :'data-hover'=>"dropdown")
      output += '<ul class="dropdown-menu" role="menu">'
